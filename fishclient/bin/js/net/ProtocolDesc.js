...
(function (protocol_def) {
    ...
    protocol_def.S2C_MERGE_PACKET = 0x101;
    protocol_def.C2S_LOGIN_ASYN_TIME = 0x111;
    protocol_def.C2S_LOGIN = 0x113;
    protocol_def.C2S_LOGIN_SESSION = 0x120;
    protocol_def.C2S_LOGIN_GM = 0x121;
    protocol_def.C2S_LOGIN_SELECTROLE = 0x114;
    protocol_def.C2S_LOGIN_CLIENTREADY = 0x115;
    protocol_def.C2S_LOGIN_CREATEROLE = 0x116;
    protocol_def.C2S_LOGIN_DELETEROLE = 0x117;
    protocol_def.C2S_LOGIN_RESTOREROLE = 0x118;
    protocol_def.C2S_ACCOUNT_GUEST = 0x11a;
    protocol_def.S2C_SYSTEM_VERSION = 0x110;
    protocol_def.S2C_ASYNTIME = 0x111;
    protocol_def.S2C_LOGIN = 0x112;
    protocol_def.S2C_LOGIN_OK = 0x113;
    protocol_def.S2C_LOGIN_ROLEINFO = 0x114;
    protocol_def.S2C_LOGIN_SELECTROLE = 0x115;
    protocol_def.S2C_LOGIN_DELETEROLE = 0x116;
    protocol_def.S2C_LOGIN_RELOGIN = 0x117;
    protocol_def.S2C_LOGIN_SESSION = 0x118;
    protocol_def.S2C_LOGIN_UPDATESESSION = 0x119;
    protocol_def.S2C_ACCOUNT_GUEST = 0x11a;
    protocol_def.S2C_OPENTIME = 0x120;
    protocol_def.S2C_SERVER_INFO = 0x128;
    protocol_def.S2C_ACCOUNT_INFO = 0x129;
    protocol_def.S2C_PROTOCOL_DESC = 0x121;
    protocol_def.S2C_CLIENT_COMMAND = 0x122;
    protocol_def.C2S_CLIENT_SETTING = 0x123;
    protocol_def.S2C_CLIENT_SETTING = 0x123;
    protocol_def.C2S_SERVER_SETTING = 0x124;
    protocol_def.S2C_SERVER_SETTING = 0x124;
    protocol_def.C2S_ROLE_RENAME = 0x125;
    protocol_def.C2S_CHANGE_SIGN = 0x126;
    protocol_def.S2C_ROLE_FREERENAME = 0x125;
    protocol_def.S2C_SERVER_ONDAY = 0x127;
    protocol_def.C2S_MAP_MOVE = 0x140;
    protocol_def.C2S_MAP_PICK = 0x141;
    protocol_def.S2C_MAP_TRACK = 0x42;
    protocol_def.S2C_MAP_DEL = 0x43;
    protocol_def.S2C_MAP_ADDPLAYER = 0x140;
    protocol_def.S2C_MAP_ADDNPC = 0x141;
    protocol_def.S2C_MAP_ADDGOODS = 0x142;
    protocol_def.S2C_MAP_ADDSUMMON = 0x143;
    protocol_def.S2C_MAP_DELSUMMON = 0x148;
    protocol_def.S2C_MAP_ADDPARTNER = 0x149;
    protocol_def.S2C_MAP_DELPARTNER = 0x14a;
    protocol_def.S2C_MAP_ROLESTATE = 0x144;
    protocol_def.S2C_MAP_CHANGESHAPE = 0x145;
    protocol_def.S2C_MAP_CHANGETITLE = 0x146;
    protocol_def.S2C_MAP_PLAYANI = 0x147;
    protocol_def.S2C_MAP_ROLETITLE = 0x14b;
    protocol_def.S2C_HANGMAP_INFO = 0x150;
    protocol_def.C2S_NPC_LOOK = 0x160;
    protocol_def.C2S_NPC_RESPOND = 0x161;
    ...
    protocol_def.C2S_ITEM_BAGEXPAND = 0x181;
    protocol_def.S2C_ITEM_LIST = 0x180;
    protocol_def.S2C_ITEM_ADD = 0x181;
    protocol_def.S2C_ITEM_UPDATE = 0x182;
    protocol_def.S2C_ITEM_DEL = 0x183;
    protocol_def.S2C_ITEM_BAGCOUNT = 0x184;
    protocol_def.C2S_ITEM_BUY = 0x403;
    protocol_def.C2S_CHAT = 0x1a0;
    protocol_def.C2S_CHAT_GM = 0x1a1;
    protocol_def.S2C_CHAT = 0x1a0;
    protocol_def.S2C_CHAT_SYSTEM = 0x1a1;
    protocol_def.S2C_NOTIFY_MESSAGE = 0x1b0;
    protocol_def.S2C_NOTIFY_FLOAT = 0x1b1;
    protocol_def.S2C_NOTIFY_FLYMESSAGE = 0x1b2;
    protocol_def.S2C_NOTIFY_FLYHINT = 0x1b3;
    protocol_def.S2C_NOTIFY_NOENOUGH = 0x1b4;
    protocol_def.S2C_NOTIFY_REWARD = 0x1b5;
    protocol_def.S2C_NOTIFY_OFFLINEREWARD = 0x1b6;
    protocol_def.C2S_HERO_LEVELUP = 0x201;
    protocol_def.S2C_HERO_PROP = 0x201;
    protocol_def.S2C_HERO_ENTERSCENE = 0x202;
    protocol_def.S2C_HERO_GOTO = 0x203;
    protocol_def.S2C_WAR_START = 0x300;
    protocol_def.S2C_WAR_ADD = 0x301;
    protocol_def.S2C_WAR_LEAVE = 0x302;
    protocol_def.S2C_WAR_STATUS = 0x303;
    protocol_def.S2C_WAR_NEXT = 0x305;
    protocol_def.S2C_WAR_TURN = 0x306;
    protocol_def.S2C_WAR_PREEND = 0x30e;
    protocol_def.S2C_WAR_END = 0x30f;
    protocol_def.S2C_WAR_REPLY = 0x30d;
    protocol_def.S2C_WAR_ATTACK_NORMAL = 0x311;
    protocol_def.S2C_WAR_ATTACK_END = 0x312;
    protocol_def.S2C_WAR_PERFORM = 0x313;
    protocol_def.S2C_WAR_PERFORM_END = 0x314;
    protocol_def.S2C_WAR_PARTNER_ATTACK = 0x315;
    protocol_def.S2C_WAR_BACKATTACK = 0x316;
    protocol_def.S2C_WAR_BACKATTACK_END = 0x317;
    protocol_def.S2C_WAR_SHAKE = 0x318;
    protocol_def.S2C_WAR_PROTECT = 0x319;
    protocol_def.S2C_WAR_ATTACK_STATUS = 0x31a;
    protocol_def.S2C_WAR_BUFF_ADD = 0x330;
    ...
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_SYSTEM_VERSION] = 'S2C_SYSTEM_VERSION';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_ASYNTIME] = 'S2C_ASYNTIME';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_LOGIN] = 'S2C_LOGIN';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_LOGIN_OK] = 'S2C_LOGIN_OK';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_LOGIN_ROLEINFO] = 'S2C_LOGIN_ROLEINFO';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_LOGIN_SELECTROLE] = 'S2C_LOGIN_SELECTROLE';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_LOGIN_DELETEROLE] = 'S2C_LOGIN_DELETEROLE';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_LOGIN_RELOGIN] = 'S2C_LOGIN_RELOGIN';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_LOGIN_SESSION] = 'S2C_LOGIN_SESSION';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_LOGIN_UPDATESESSION] = 'S2C_LOGIN_UPDATESESSION';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_ACCOUNT_GUEST] = 'S2C_ACCOUNT_GUEST';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_OPENTIME] = 'S2C_OPENTIME';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_SERVER_INFO] = 'S2C_SERVER_INFO';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_ACCOUNT_INFO] = 'S2C_ACCOUNT_INFO';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_PROTOCOL_DESC] = 'S2C_PROTOCOL_DESC';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_CLIENT_COMMAND] = 'S2C_CLIENT_COMMAND';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_CLIENT_SETTING] = 'S2C_CLIENT_SETTING';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_SERVER_SETTING] = 'S2C_SERVER_SETTING';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_ROLE_FREERENAME] = 'S2C_ROLE_FREERENAME';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_SERVER_ONDAY] = 'S2C_SERVER_ONDAY';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_TRACK] = 'S2C_MAP_TRACK';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_DEL] = 'S2C_MAP_DEL';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_ADDPLAYER] = 'S2C_MAP_ADDPLAYER';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_ADDNPC] = 'S2C_MAP_ADDNPC';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_ADDGOODS] = 'S2C_MAP_ADDGOODS';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_ADDSUMMON] = 'S2C_MAP_ADDSUMMON';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_DELSUMMON] = 'S2C_MAP_DELSUMMON';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_ADDPARTNER] = 'S2C_MAP_ADDPARTNER';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_DELPARTNER] = 'S2C_MAP_DELPARTNER';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_ROLESTATE] = 'S2C_MAP_ROLESTATE';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_CHANGESHAPE] = 'S2C_MAP_CHANGESHAPE';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_CHANGETITLE] = 'S2C_MAP_CHANGETITLE';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_PLAYANI] = 'S2C_MAP_PLAYANI';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_MAP_ROLETITLE] = 'S2C_MAP_ROLETITLE';
    ...
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_ITEM_DEL] = 'S2C_ITEM_DEL';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_ITEM_BAGCOUNT] = 'S2C_ITEM_BAGCOUNT';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_CHAT] = 'S2C_CHAT';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_CHAT_SYSTEM] = 'S2C_CHAT_SYSTEM';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_NOTIFY_MESSAGE] = 'S2C_NOTIFY_MESSAGE';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_NOTIFY_FLOAT] = 'S2C_NOTIFY_FLOAT';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_NOTIFY_FLYMESSAGE] = 'S2C_NOTIFY_FLYMESSAGE';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_NOTIFY_FLYHINT] = 'S2C_NOTIFY_FLYHINT';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_NOTIFY_NOENOUGH] = 'S2C_NOTIFY_NOENOUGH';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_NOTIFY_REWARD] = 'S2C_NOTIFY_REWARD';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_NOTIFY_OFFLINEREWARD] = 'S2C_NOTIFY_OFFLINEREWARD';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_HERO_PROP] = 'S2C_HERO_PROP';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_HERO_ENTERSCENE] = 'S2C_HERO_ENTERSCENE';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_HERO_GOTO] = 'S2C_HERO_GOTO';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_START] = 'S2C_WAR_START';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_ADD] = 'S2C_WAR_ADD';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_LEAVE] = 'S2C_WAR_LEAVE';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_STATUS] = 'S2C_WAR_STATUS';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_NEXT] = 'S2C_WAR_NEXT';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_TURN] = 'S2C_WAR_TURN';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_PREEND] = 'S2C_WAR_PREEND';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_END] = 'S2C_WAR_END';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_REPLY] = 'S2C_WAR_REPLY';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_ATTACK_NORMAL] = 'S2C_WAR_ATTACK_NORMAL';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_ATTACK_END] = 'S2C_WAR_ATTACK_END';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_PERFORM] = 'S2C_WAR_PERFORM';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_PERFORM_END] = 'S2C_WAR_PERFORM_END';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_PARTNER_ATTACK] = 'S2C_WAR_PARTNER_ATTACK';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_BACKATTACK] = 'S2C_WAR_BACKATTACK';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_BACKATTACK_END] = 'S2C_WAR_BACKATTACK_END';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_SHAKE] = 'S2C_WAR_SHAKE';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_PROTECT] = 'S2C_WAR_PROTECT';
    protocol_def.S2C_CMD_2_PROTODESC[protocol_def.S2C_WAR_ATTACK_STATUS] = 'S2C_WAR_ATTACK_STATUS';
    ...
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_LOGIN] = 'C2S_LOGIN';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_LOGIN_SESSION] = 'C2S_LOGIN_SESSION';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_LOGIN_GM] = 'C2S_LOGIN_GM';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_LOGIN_SELECTROLE] = 'C2S_LOGIN_SELECTROLE';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_LOGIN_CLIENTREADY] = 'C2S_LOGIN_CLIENTREADY';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_LOGIN_CREATEROLE] = 'C2S_LOGIN_CREATEROLE';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_LOGIN_DELETEROLE] = 'C2S_LOGIN_DELETEROLE';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_LOGIN_RESTOREROLE] = 'C2S_LOGIN_RESTOREROLE';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_ACCOUNT_GUEST] = 'C2S_ACCOUNT_GUEST';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_CLIENT_SETTING] = 'C2S_CLIENT_SETTING';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_SERVER_SETTING] = 'C2S_SERVER_SETTING';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_ROLE_RENAME] = 'C2S_ROLE_RENAME';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_CHANGE_SIGN] = 'C2S_CHANGE_SIGN';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_MAP_MOVE] = 'C2S_MAP_MOVE';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_MAP_PICK] = 'C2S_MAP_PICK';
    ...
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_ITEM_BAGEXPAND] = 'C2S_ITEM_BAGEXPAND';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_ITEM_BUY] = 'C2S_ITEM_BUY';
    protocol_def.C2S_CMD_2_PROTODESC[protocol_def.C2S_CHAT] = 'C2S_CHAT';
