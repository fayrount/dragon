...
(function (core) {
    var materialmgr = /** @class */ (function () {
        ...
        materialmgr.prototype.get_mat_loader = function (res) {
            if (this.m_mat_loader.hasOwnProperty(res) == false) {
                this.m_mat_loader[res] = new core.material_loader(res);
            }
        ...
        materialmgr.prototype.getmapbkres = function (respath) {
            var ret = utils.getitembycls("mapbkmaterial", core.mapbkmaterial);
            ret.re_init(respath);
            return ret;
        };
